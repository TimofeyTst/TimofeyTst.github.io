 ...
 *
 * Inner pages show a back link to the home portfolio.
 * Home shows only the theme toggle floating in the corner.
 */
...
function ThemeButton({ isDark, toggleTheme }: { isDark: boolean; toggleTheme: () => void }) {
  return (
    <button
      onClick={toggleTheme}
...
export default function GlobalNav() {
  ...
  const animateBar = !isHome && !barShown.current
  if (!isHome) barShown.current = true
          ...
          <div className="min-w-0 flex items-center">
            ...
            >
              ...
              >
                ...
                <span className="hidden sm:inline">timofeytst</span>
              </Link>
              {pageTitle && (
                <>
  ...
  // Home: theme toggle floats at top-right
